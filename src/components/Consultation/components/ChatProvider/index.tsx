...
type ChatContextType = {
    ...
    isScheduleWindowOpen: boolean;
    setIsScheduleWindowOpen: (isScheduleWindowOpen: boolean) => void;
...
export const ChatProvider: React.FC = ({children}) => {
    ...
    const isScheduleWindowOpenRef = useRef(false);
    const [isScheduleWindowOpen, setIsScheduleWindowOpen] = useState(false);
    ...
    useEffect(() => {
        if (room && chatClient) {
            chatClient
                .getConversationByUniqueName(room.localParticipant.sid)
